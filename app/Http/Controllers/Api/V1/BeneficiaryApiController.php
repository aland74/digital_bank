...
class BeneficiaryApiController extends Controller
{
    ...
    {
        return response()->json(['beneficiaries' => $request->user()->beneficiaries()->orderBy('is_favorite', 'desc')->get()]);
    }
    ...
    {
        return response()->json($request->user()->beneficiaries()->findOrFail($id));
    }
